...
def classifyWithXlmr(text):
    loaded_model = TFBertForSequenceClassification.from_pretrained('D:\\term8\\final_project\\xlm-roberta-Model')
    lines = list(text)
...
# classifyWithXlmr('شایعه ۲۰ برابر بودن آمار بیماران کرونایی')